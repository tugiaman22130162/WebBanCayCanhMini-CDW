    ...
    useEffect(() => {
        const fetchDesigns = async () => {
            try {
                ...
                // Lọc ra các thiết kế đã được duyệt hoặc đã mua (lấy tất cả, không hiển thị các bản sao/mua lại)
    ...
    return (
        <MainLayout>
            <div className="min-h-screen bg-background text-on-surface font-body flex flex-col">
                <header className="bg-white pt-10 pb-8 px-6 border-b border-gray-100">
                    <div className="max-w-7xl mx-auto">
                        ...
                        >
                            ...
                            <span className="text-gray-800 font-semibold truncate">Thiết kế nổi bật</span>
                        </motion.nav>
                        <h2 className="text-4xl font-bold text-on-surface mb-2">Thiết kế nổi bật</h2>
                        <p className="text-on-surface-variant max-w-2xl">
                            Bộ sưu tập những tác phẩm Terrarium độc đáo và sáng tạo nhất từ cộng đồng khách hàng của MiniGarden.
                        </p>
                    </div>
                </header>
                ...
                <section className="px-6 py-12 max-w-7xl mx-auto flex-1 w-full">
                    <div className="flex justify-end mb-8">
                        <Link
                            to="/builder"
                            className="px-6 py-2.5 rounded-full font-semibold text-white bg-gradient-to-r from-primary to-primary-container hover:scale-[1.02] shadow-md active:scale-95 transition-all duration-300 flex items-center gap-2 group"
                        >
