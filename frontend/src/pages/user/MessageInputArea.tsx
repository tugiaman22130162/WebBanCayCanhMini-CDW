...
export default function MessageInputArea({
    isLoggedIn, inputText, setInputText,
    replyingMessageId, editingMessageId, messages,
    onCancelReply, onCancelEdit,
    onSendMessage, onSendSticker, onSendImage,
    sendTypingStatus
    ...
    return (
        <div className="p-4 bg-white border-t border-gray-100 shrink-0 flex flex-col gap-2">
            <ChatBanners 
                ...
                messages={messages} isAdmin={false} 
            ...
            {!isLoggedIn ? (
                ...
                <form onSubmit={handleSubmit} className="flex items-end gap-3">
                    <ChatActions onSendImage={onSendImage} onSendSticker={onSendSticker} uploadId="user-chat-image-upload" />
                    <textarea
